...
const createUseBatchesForDataTable = (
    ...
    const useBatchesForDataTable = (page: number, pageSize: number, search: string) => {
        return useCourseBatches(courseId, search, page > 0 ? page - 1 : 0, pageSize);
    };
    (useBatchesForDataTable as UseBatchesForDataTable & { isQueryHook?: boolean }).isQueryHook =
        true;
...
export function CourseBatchesTable({ courseId, onAssign, onDelete }: CourseBatchesTableProps) {
