...
export function CourseStudentsTable({ courseId, onAssign, onDelete }: CourseStudentsTableProps) {
    const router = useRouter();

    function useStudentsForDataTable(page: number, pageSize: number, search: string) {
        return useCourseStudents(courseId, search, page > 0 ? page - 1 : 0, pageSize);
    }
