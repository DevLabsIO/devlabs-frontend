        ...
        return navGroups
            .map((group) => ({
                ...
                items: group.items.filter((item) =>
                    item.roles.some((role) => (session.user.groups as string[]).includes(role))
                ),
            }))
                ...
                <SidebarHeader className="border-b border-sidebar-border bg-linear-to-br from-sidebar/40 via-sidebar/60 to-sidebar/80 dark:from-sidebar/60 dark:via-sidebar/80 dark:to-sidebar backdrop-blur-sm p-0">
                    <Link href="/" className="block">
                        <div className="flex items-center p-2 min-h-16 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:p-3">
                            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-linear-to-br from-blue-600 to-purple-600 text-white shadow-lg ring-2 ring-primary/20 group-data-[collapsible=icon]:h-8 group-data-[collapsible=icon]:w-8 transition-all duration-200">
                                        ...
                                        <div className="ml-3 flex items-center justify-between flex-1 min-w-0 group-data-[collapsible=icon]:hidden overflow-hidden">
                                            ...
                                            <DropdownMenu>
                                                <DropdownMenuTrigger asChild>
                                                    <button
                                                        className="shrink-0 p-1.5 rounded-md hover:bg-sidebar-accent/30 transition-all duration-200"
                                                        title="User menu"
                                                    >
                                                        ...
                                                        <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                                                            <Avatar className="h-8 w-8 rounded-lg ring-2 ring-primary/20">
                                                                {session.user.image ? (
                                                                    ...
                                                                    <AvatarFallback className="rounded-lg bg-linear-to-br from-primary to-primary/80 text-primary-foreground">
