...
export function GridItem<T extends Record<string, unknown>>({
    ...
    const getDescription = () => (fieldConfig.description ? item[fieldConfig.description] : null);
    const getCreatedAt = () => (fieldConfig.createdAt ? item[fieldConfig.createdAt] : null);
    const getCreatedBy = () => (fieldConfig.createdBy ? item[fieldConfig.createdBy] : null);
                    ...
                    <div className="space-y-2">
                        ...
                        {getCreatedAt() && (
                            <div className="flex items-center text-sm text-muted-foreground">
                                ...
                                <span>{new Date(String(getCreatedAt())).toLocaleDateString()}</span>
                            </div>
                        )}
                    </div>
                )}
