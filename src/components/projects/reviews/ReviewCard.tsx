...
export default function ReviewCard({ review, projectId, projectCourses }: ReviewCardProps) {
        ...
        <Card className="flex flex-col h-full">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                        ...
                        {relevantCourses.length > 3 && (
                            <Badge variant="outline">+{relevantCourses.length - 3} more</Badge>
                        )}
            ...
            <CardFooter className="p-4">
                ...
                {review.status === "SCHEDULED" && canEvaluate && (
                    <Button variant="outline" className="w-full text-sm" onClick={handleViewReview}>
                        View Review
                    </Button>
                )}
                {isStudent && (
