...
import { PlusCircle, Pencil, AlertCircle, Check, ChevronsUpDown } from "lucide-react";
...
export function RubricFormSection({ selectedRubricId, onRubricChange }: RubricFormSectionProps) {
