...
const assignColorsToCourses = (courses: StudentCourse[]): StudentCourseWithColor[] => {
...
export function MyCoursesPage() {
    ...
    if (isLoadingCourses) {
        return <div className="container mx-auto p-4 text-center">Loading your courses...</div>;
    }
        ...
        <div className="space-y-8 p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredAndSortedCourses.map((course) => (
                    <StudentCourseCard key={course.id} course={course} onClick={handleCardClick} />
                ))}
            </div>
        </div>
    );
