...
export function FileUploadSection({ reviewId }: FileUploadSectionProps) {
    ...
    const reviewStatus = review ? calculateReviewStatus(review.startDate, review.endDate) : null;
        ...
        <Card className="w-full">
            ...
            <CardContent className="space-y-6">
                {canUpload ? (
                        ...
                        {selectedFiles.length > 0 && (
                            <div className="space-y-3">
                                ...
                                {selectedFiles.map((file) => {
                                    ...
                                    const isFileUploading = fileProgress > 0 && fileProgress < 100;
                    ...
                    <Alert>
                        <AlertDescription>
                            Files cannot be uploaded for this review as it is already completed.
                        </AlertDescription>
                    </Alert>
                ) : (
                    <Alert>
