...
export default function SignIn() {
    ...
    return (
        <div className="relative min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-black overflow-hidden flex items-center justify-center">
            <ParticleField />
            ...
            <div className="relative z-10 w-full max-w-lg mx-4 animate-fadeInUp">
                <div className="relative p-10 rounded-2xl backdrop-blur-xl bg-linear-to-b from-white/8 to-white/2 border border-white/8 shadow-2xl">
                    <div className="absolute inset-0 rounded-2xl bg-linear-to-b from-blue-500/3 via-transparent to-indigo-500/3" />

                    <div className="relative z-10">
                        <div className="text-center mb-10">
                            <h1 className="text-6xl font-bold mb-4 bg-linear-to-r from-blue-400 via-indigo-400 to-cyan-300 bg-clip-text text-transparent animate-fadeInUp">
                                Devlabs
                            </h1>
                        ...
                        <div className="space-y-8 animate-fadeInUp animation-delay-600">
                            ...
                            >
                                <div className="absolute inset-0 rounded-xl bg-linear-to-r from-blue-600 to-indigo-600 opacity-90 group-hover:opacity-100 transition-opacity duration-300" />

                                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                                    <div className="absolute inset-0 bg-linear-to-r from-transparent via-white/10 to-transparent skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-out rounded-xl" />
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-5 rounded-xl bg-white/2 border border-white/5 hover:bg-white/4 transition-colors duration-300">
