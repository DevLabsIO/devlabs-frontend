...
export default function CoursePage() {
    ...
    const [isAssignInstructorOpen, setIsAssignInstructorOpen] = React.useState(false);
    ...
    const [instructorToDelete, setInstructorToDelete] = React.useState<User | null>(null);
    ...
    return (
        <div className="container mx-auto py-10">
            ...
            <AssignInstructorDialog
                ...
                onAssign={(instructorIds) => assignInstructorsMutation.mutate(instructorIds)}
            ...
            <DeleteDialog
                ...
                onConfirm={() => batchToDelete && removeBatchMutation.mutate(batchToDelete.id)}
            ...
            <DeleteDialog
                ...
                onConfirm={() =>
                    instructorToDelete && removeInstructorMutation.mutate(instructorToDelete.id)
                }
